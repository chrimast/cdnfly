...
download "https://github.com/chrimast/cdnfly/raw/main/cdnfly/v5.1.13/agent/$tar_gz_name" "https://github.com/chrimast/cdnfly/raw/main/cdnfly/v5.1.13/agent/$tar_gz_name" "$tar_gz_name"
