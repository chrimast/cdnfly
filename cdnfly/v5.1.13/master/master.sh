...
cd /opt/
download "https://github.com/chrimast/cdnfly/raw/main/cdnfly/v5.1.13/master/$tar_gz_name" "https://github.com/chrimast/cdnfly/raw/main/cdnfly/v5.1.13/master/$tar_gz_name" "$tar_gz_name"
